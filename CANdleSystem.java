...
public class CANdleSystem {
    ...
    private final RainbowAnimation rainbow = new RainbowAnimation(8, 262);
    private final FireAnimation fire = new FireAnimation(8, 262);
    private final LarsonAnimation larson = new LarsonAnimation(8, 262);
